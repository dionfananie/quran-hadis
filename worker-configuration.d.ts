/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1105082a02aae6dbeb2a6bc5eb840926)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_VECTOR_SEARCH_ENDPOINT: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "VITE_VECTOR_SEARCH_ENDPOINT">> {}
}
