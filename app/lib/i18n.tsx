...
const id = {
	...
	"hadith.jumpTo": "Lompat ke nomor",
	"hadith.go": "Buka",
	"hadith.pageLabel": "Halaman",
	"hadith.of": "dari",

	"search.title": "Pencarian",
	"search.placeholder": "Cari dengan bahasa alami…",
	"search.subtitle": "Pencarian semantik berbasis AI yang memahami makna, bukan sekadar kata kunci",
...
const en: Record<keyof typeof id, string> = {
	...
	"hadith.jumpTo": "Jump to number",
	"hadith.go": "Go",
	"hadith.pageLabel": "Page",
	"hadith.of": "of",

	"search.title": "Search",
	"search.placeholder": "Search with natural language…",
	"search.subtitle": "AI-powered semantic search that understands meaning, not just keywords",
