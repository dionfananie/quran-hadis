...
const id = {
	...
	common_shareImage: "Bagikan Gambar",
	common_shareImageHint: "Gambar ayat akan dibagikan ke aplikasi yang Anda pilih.",
	common_more: "Lainnya",
	common_verse: "Ayat",
	common_verses: "Ayat",
	...
	"home.quickRead": "Baca Cepat",
	"home.quickReadDesc": "Mulai dari juz pertama, mudah diakses setiap hari.",
	"home.allJuz": "Semua Juz",
	"home.allJuzDesc": "Telusuri seluruh 30 juz Al-Qur'an.",
	"home.readJuz": "Baca Juz",
	"home.juz": "Juz",
...
const en: Record<keyof typeof id, string> = {
	...
	common_shareImage: "Share Image",
	common_shareImageHint: "An ayah image will be shared to the app you choose.",
	common_more: "More",
	common_verse: "Verse",
	...
	"home.quickRead": "Quick Read",
	"home.quickReadDesc": "Start from the first juz, easy to reach every day.",
	"home.allJuz": "All Juz",
	"home.allJuzDesc": "Browse all 30 juz of the Qur'an.",
	"home.readJuz": "Read Juz",
	"home.juz": "Juz",
