...
const SHOW_TRANSLATION_KEY = "moeslem.show-translation";
export function useShowTranslation() {
	return useStoredState<boolean>(SHOW_TRANSLATION_KEY, true);
}

const SHOW_TAJWEED_KEY = "moeslem.show-tajwid";
export function useShowTajwid() {
	return useStoredState<boolean>(SHOW_TAJWEED_KEY, false);
}
